# Generated by Django 4.2.6 on 2023-10-24 23:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "uid",
                    models.CharField(max_length=50, verbose_name="User ID in base64"),
                ),
                (
                    "email",
                    models.EmailField(
                        blank=True,
                        help_text="Used only in case of email changing confirmation",
                        max_length=254,
                    ),
                ),
                (
                    "code",
                    models.CharField(
                        max_length=255, verbose_name="Activation/confirmation code"
                    ),
                ),
                (
                    "expiration_date",
